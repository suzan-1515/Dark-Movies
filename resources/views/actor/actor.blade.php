      ...
      <div class="row flexbox-center">
        ...
        <div class="col-lg-5 text-lg-left text-center">
          <div class="transformers-content">
            <img src="{{asset('images/actor/'.$actor->image )}}" alt="about" style="width: 100%;height: 100%;" />
          </div>
        </div>
        <div class="col-lg-7" style="height: auto">
          <div class="transformers-content mtr-30">
            <h2 style="color: #fff;padding-left: 20px;">{{ $actor->name }}</h2>
            <ul>
              ...
              <li>
                ...
                <div class="transformers-right" style="color: #fff;">
                  <a style="color: #fff;margin: 5px;" href="https://www.facebook.com/{{ $actor->facebook }}"><i class="fab fa-facebook-f"></i></a>
                  <a style="color: #fff;margin: 5px;" href="https://twitter.com/{{ $actor->twitter }}"><i class="fab fa-twitter"></i></a>
                  <a style="color: #fff;margin: 5px;" href="https://ml.wikipedia.org/wiki/{{ $actor->wiki }}"><i class="fab fa-wikipedia-w"></i></a>
...
@endif
          <div class="details-reply">
            <h2>Leave a Reply</h2>
            <form method="POST" action="/actor/68{{$actor->id}}439">
              @csrf
              <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-12">
                  <div class="textarea-container">
                    <textarea placeholder="Type Here Message" name="comments" rows="4"></textarea>
          ...
          <div class="details-comment">
            <button class="mvbutton" name="submit">Post Comment</button>
            <p style="flex: 6;"></p>
          </div>
        </form>
        @if($comment)
          ...
          <div class="details-thumb">
            <div class="details-thumb-prev">
              ...
              <div class="thumb-text">
                <p><h4><a style="color: #fff;text-decoration: none;" href="/actor/68{{$previous}}439"> Previous Post</a></h4></p>
              </div>
                @endif
            </div>
            <div class="details-thumb-next">
              ...
              <div class="thumb-text">
                ...
                <p><h4><a style="color: #fff;text-decoration: none;" href="/actor/68{{$next}}439">Next Post</a></h4></p>
              </div>
              <div class="thumb-icon">
      ...
      <div class="col-lg-3 text-center text-lg-left" style="padding-left:0;background-color:rgb(10,10,10);border-top: 1px solid red;border-bottom: 1px solid red;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        <div class="share">
          ...
          <img style="margin-top: 20px;" src="{{asset('images/ads/sidebar1.png') }}" alt="sidebar" />
          <img style="margin-top: 20px;" src="{{asset('images/ads/sidebar1.png') }}" alt="sidebar" />
        </div>
      </div>
    </div>
