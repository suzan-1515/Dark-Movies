...
@section('panel')
              <div class="col-lg-12">
                <div class="block" style="background-color: #222222;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                  <div class="title"><strong>Edit Genre</strong></div>
                  ...
                  @endif
                    <form class="form-horizontal"  method="POST" action="/admin/genre/{{ $genre->id }}">
                    	  {{ method_field('PATCH') }}
                           {{ csrf_field() }}
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Genre Name</label>
                        <div class="col-sm-9">
