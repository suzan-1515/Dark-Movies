					...
					<div class="row flexbox-center">
						...
						<div class="col-lg-5 text-lg-left text-center">
							<div class="transformers-content">
								<img  src="{{asset('images/director/'.$director->image )}}" alt="about"  />
							</div>
						</div>
						<div class="col-lg-7" style="height: auto">
							<div class="transformers-content mtr-30">
								<h2 style="color: #fff;padding-left: 20px;">{{ $director->name }}</h2>
								<ul>
								<li>
									...
									<li>
										...
										<div class="transformers-right" style="color: #fff;">
											<a style="color: #fff;margin: 5px;" href="https://www.facebook.com/{{ $director->facebook }}"><i class="fab fa-facebook-f"></i></a>
											<a style="color: #fff;margin: 5px;" href="https://twitter.com/{{ $director->twitter }}"><i class="fab fa-twitter"></i></a>
											<a style="color: #fff;margin: 5px;" href="https://ml.wikipedia.org/wiki/{{ $director->wiki }}"><i class="fab fa-wikipedia-w"></i></a>
...
@endif
							<div class="details-reply">
								<h2>Leave a Reply</h2>
								<form method="POST" action="/director/68{{$director->id}}439">
									@csrf
									<div class="row">
										<div class="col-lg-6">
										...
										<div class="col-lg-6">
											<div class="select-container">
												<input type="name" name="lastname" placeholder="Name"/>
							...
							<div class="details-thumb">
								<div class="details-thumb-prev">
									...
									<div class="thumb-text">
										<p><h4><a style="color: #fff;text-decoration: none;" href="/director/68{{$previous}}439"> Previous Post</a></h4></p>
									</div>
								    @endif
								</div>
								<div class="details-thumb-next">
									...
									<div class="thumb-text">
										...
										<p><h4><a style="color: #fff;text-decoration: none;" href="/director/68{{$next}}439">Next Post</a></h4></p>
									</div>
									<div class="thumb-icon">
